...
public interface Sync {
    ...
    Response addItemsToCollection(
            @Body SyncItems items
    ) throws OAuthUnauthorizedException;
    /**
     * <b>OAuth Required</b>
     * by alexandre roux
     * <p> Sync Progress of an item.
     *
     * @param the item.
     */
    @POST("/sync/playback")
    ...
    Response deleteItemsFromCollection(
            @Body SyncItems items
    ) throws OAuthUnauthorizedException;
    ...
    List<BaseMovie> watchedMovies(
            @EncodedQuery("extended") Extended extended) throws OAuthUnauthorizedException;
     ...
     */
    @POST("/sync/history")
    Response addItemsToWatchedHistory(
            @Body SyncItems items
    ) throws OAuthUnauthorizedException;
    ...
    Response deleteItemsFromWatchedHistory(
            @Body SyncItems items) throws OAuthUnauthorizedException;
