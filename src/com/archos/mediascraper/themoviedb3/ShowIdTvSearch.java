    ...
    public static ShowIdTvSearchResult getTvShowResponse(String showKey, int showId, String language, final boolean adultScrape, MyTmdb tmdb) {
        ...
        if (myResult == null) {
            ...
            try {
                ...
                Response<TvShow> seriesResponse = tmdb.tvService().tv(showId, language, new AppendToResponse(AppendToResponseItem.EXTERNAL_IDS, AppendToResponseItem.IMAGES, AppendToResponseItem.CREDITS, AppendToResponseItem.CONTENT_RATINGS, AppendToResponseItem.TRANSLATIONS), options).execute();
