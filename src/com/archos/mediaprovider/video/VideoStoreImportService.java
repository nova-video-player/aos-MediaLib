...
public class VideoStoreImportService extends Service implements Handler.Callback {
    ...
    private void processDeleteFileAndVobCallback() {
        ...
        try {
            // tidy up the accumulated actor director writer tagline producer screenplay seasonplot studio genre piled up in v_.*_deletable tables in one shot during deletes
