 ...
 */
public class ArchosStreamClientImpl extends AbstractStreamClient<StreamClientConfigurationImpl, ArchosStreamClientImpl.HttpContentExchange> {
    ...
    static public class HttpContentExchange extends ContentExchange {
        ...
        protected void applyRequestURLMethod() {
            ...
            /* ugly nvidia shield workaround*/
            String path = requestOperation.getURI().getPath();
            setRequestURI(path == null ? "/" : path);
        }
